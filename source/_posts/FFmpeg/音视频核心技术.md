...
![FFmpeg音视频架构](音视频核心技术/FFmpeg音视频架构.png)

![FFmpeg音视频架构-01](音视频核心技术/FFmpeg音视频架构-01.png)

![FFmpeg音视频架构-02](C:/Users/mrmia/Downloads/imageFFmpeg/FFmpeg音视频架构-02.png)
...
![播放器架构](音视频核心技术/播放器架构.png)

**渲染流程**：

![渲染流程](音视频核心技术/渲染流程.png)
...
![FFmpeg处理音视频流程](音视频核心技术/FFmpeg处理音视频流程.png)

![FFmpeg基本信息查询命令](音视频核心技术/FFmpeg基本信息查询命令.png)

![FFmpeg录屏命令](音视频核心技术/FFmpeg录屏命令.png)

```shell
$ ffplay -s 2560x1600 -pix_fmt uyvy422 out.yuv
```

![分解与复用-01](音视频核心技术/分解与复用-01.png)

![多媒体格式转换](音视频核心技术/多媒体格式转换.png)
...
![SDL渲染基本原理](音视频核心技术/SDL渲染基本原理.png)
...
![Android架构](音视频核心技术/Android架构.png)
...
![java调用c方法二](音视频核心技术/java调用c方法二.png)

![注册Native方法的最佳时机](音视频核心技术/注册Native方法的最佳时机.png)
...
![原始类型的Signature](音视频核心技术/原始类型的Signature.png)

![类的Signature](音视频核心技术/类的Signature.png)
