...
![泛娱乐化直播架构](移动端音视频入门/泛娱乐化直播架构.png)
...
![FFMPEG直播命令](移动端音视频入门/FFMPEG直播命令.png)

![测试流媒体服务器](移动端音视频入门/测试流媒体服务器.png)

## 4. 音频基础知识

![声音三要素](移动端音视频入门/声音三要素.png)

图一音量：甲乙的振动频率相同、振幅不同。图二音调：甲乙振幅相同、频率不同

![音量与音调](移动端音视频入门/音量与音调.png)

![音色](移动端音视频入门/音色.png)

![人类听觉范围](移动端音视频入门/人类听觉范围.png)

![听觉-发声范围](移动端音视频入门/听觉-发声范围.png)
...
![频域掩蔽效应](移动端音视频入门/频域掩蔽效应.png)

![时域掩蔽效应](移动端音视频入门/时域掩蔽效应.png)

![音频编码过程](移动端音视频入门/音频编码过程.png)
...
![常见的音频编码器](移动端音视频入门/常见的音频编码器.png)

![音频编码器性能对比](移动端音视频入门/音频编码器性能对比.png)
...
![宏块划分完成](移动端音视频入门/宏块划分完成.png)

子块划分：

![子块划分](移动端音视频入门/子块划分.png)
...
![组内宏块查找](移动端音视频入门/组内宏块查找.png)

![运动估算](移动端音视频入门/运动估算.png)

![运动矢量与补偿压缩](移动端音视频入门/运动矢量与补偿压缩.png)

### 11.2 帧内预测

![帧内预测](移动端音视频入门/帧内预测.png)

![计算帧内预测残差值](移动端音视频入门/计算帧内预测残差值.png)

![预测模式与残差值压缩](移动端音视频入门/预测模式与残差值压缩.png)

### 11.3 DCT 压缩

![DCT压缩](移动端音视频入门/DCT压缩.png)

![压缩后的结果](移动端音视频入门/压缩后的结果.png)

### 11.4 VLC 压缩

![VLC压缩](移动端音视频入门/VLC压缩.png)

### 11.5 CABAC 压缩

![CABAC压缩](移动端音视频入门/CABAC压缩.png)
