...
### 1.1 MediaStream (aka getUserMedia)
...
![内部WebRTC-API](webrtc-专题-02/内部WebRTC-API.png)
...
![音视频采集输出](webrtc-专题-02/音视频采集输出.png)

#### 1.1.5 约束对象(Constraints)
...
![webrtc分层协议](webrtc-专题-02/webrtc分层协议.png)
...
![几种传输比较](webrtc-专题-02/几种传输比较.png)
...
![RTCPeerConnection](webrtc-专题-02/RTCPeerConnection.png)
...
![DataChannel和WebSocket的区别](webrtc-专题-02/DataChannel和WebSocket的区别.png)
...
![Finding connection candidates（找到联系候选人）](webrtc-专题-02/Finding_connection_candidates.png)

![WebRTC data pathways（WebRTC数据通路）](webrtc-专题-02/WebRTC_data_pathways.png)
...
![JSEP_architecture](webrtc-专题-02/JSEP_architecture.png)

### 2.5 会话描述协议（Session Description Protocol）
